        ...
        <div class="row">
            ...
            <div class="col-5">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h4 class="class-title">Register</h4>
        ...
        if (strlen($password) >= 6 && strlen($comfirmPassword) >= 6) {
            if ($password == $comfirmPassword) {
                ...
                if ($status) {
                    ...
                    echo "<div class=\"w-50 mx-auto mt-5 alert alert-success text-center\">Register Success!</div>";
                } else {
                    echo "<div class=\"w-75 mx-auto mt-5 alert alert-warning text-center\">Your password is not strong password! (eg . contain A-Z a-z 0-9 !@#$%^!&*)</div>";
                }
                ;
